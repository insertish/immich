...
class MaintenanceStatusResponseDto {
  ...
  @override
  String toString() => 'MaintenanceStatusResponseDto[action=$action, error=$error, exitingMaintenanceMode=$exitingMaintenanceMode, operation=$operation, progress=$progress]';
